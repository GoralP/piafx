...
export class Sidebar extends Component {
  ...
  render() {
    ...
    return (
      <Sider
        className={`gx-app-sidebar custom_sidebar  ${window.location.pathname=='/cotaccountancy' && multitab=='true'?'ca_sidebar':null} ${drawerStyle} ${themeType !== THEME_TYPE_LITE ? 'gx-layout-sider-dark' : null}`}
        trigger={null}
