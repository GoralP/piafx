...
// 	  sec_pro_ticker_price:0,
// 	  ml_ticker:0,
// 	  ml_ticker_price:0,
// 	  dis_ml_ticker_price:0,
// 	  sec_ml_ticker_price:0,
// 	  year_discount_price:0,
// 	  dis_year_discount_price:0,
// 	  sec_year_discount_price:0,
...
//     // }
//   }
//   select_ticker(event,type,id,index,code)
//   {
// 		if(this.props.pricing_data[0])
// 		{
// 			var sector_price = this.props.pricing_data[0][1]
// 		}
// 	  if(event)
// 	  {
...
// 	{
//         var sector_price = this.props.pricing_data[0][1];
// 		var year_discount1 = this.props.pricing_data[0][1]['year_discount'];	 
// 		var sector_discount = this.props.pricing_data[0][1]['sector_discount'];	 
//     }
// 	var temp_year_discount = 1-(year_discount1/100);
// 	var temp_sector_discount = 1-(sector_discount/100);
// 	if(year)
// 	{
// 		if(ML_count>0)
// 		{   
...
//             pro_array.map((key,index)=>{
//                 pro_total += sector_price[key];
//             })
//             ML_array.map((key,index)=>{
//                 ML_total += sector_price[key+ '_ML'];
// 			})
// 			pro_total = pro_total*12;
// 			ML_total = ML_total*12;
//             var sec_pro_total = pro_total*temp_sector_discount;
//             var dis_pro_total = (sec_pro_total)*temp_year_discount;
//             var sec_ML_total = ML_total*temp_sector_discount;
//             var dis_ML_total = sec_ML_total*temp_year_discount;
//             var sector_total = pro_total + ML_total +rent;
//             var sec_sector_total = sec_pro_total + sec_ML_total +rent;
//             var dis_sector_total = (sec_pro_total + sec_ML_total +rent)*temp_year_discount;
//             this.setState({
//                 ml_platform_title:"ML Platform Rent",
//                 ml_platform:rent.toFixed(2),
//                 dis_ml_platform:dis_rent.toFixed(2),
//                 pro_ticker:pro_count,
//                 pro_ticker_price:pro_total.toFixed(2),
//                 sec_pro_ticker_price:sec_pro_total.toFixed(2),
//                 dis_pro_ticker_price:dis_pro_total.toFixed(2),
//                 ml_ticker:ML_count,
//                 ml_ticker_price:ML_total.toFixed(2),
//                 sec_ml_ticker_price:sec_ML_total.toFixed(2),
//                 dis_ml_ticker_price:dis_ML_total.toFixed(2),
//                 year_discount_price:0,
//                 coupon_discount_price:0,
//                 paypal_fee:0,
//                 total:sector_total.toFixed(2),
//                 sec_total:sec_sector_total.toFixed(2),
//                 dis_total:dis_sector_total.toFixed(2)
//             });
// 		}
...
// 											{
// 											Object.keys(this.props.ticker_data[0]).map((key,index) => {
// 												var pro_id = "pro_"+index
// 												var ml_id = "ML_"+index
// 												var sector_name = key
// 											return (
// 												<tr>
// 												<td style={{'cursor':"pointer"}} >{sector_name}  </td>
// 												<td>
// 													{/* <label class="switches">
// 													<input class="switchinput" type="checkbox" id={id} />
// 													<span class="slider round"></span>
// 													</label> */}
// 													{this.state[pro_id]? <span><Switch size="small" id={pro_id} checked={this.state[pro_id]} onChange={(e)=>this.select_ticker(e,'PRO',pro_id,index,sector_name)} checked/></span>:
// 													<span><Switch size="small" id={pro_id} checked={this.state[pro_id]} onChange={(e)=>this.select_ticker(e,'PRO',pro_id,index,sector_name)}/></span>}
// 													</td>
// 												<td>{this.state[ml_id]?<span><Switch size="small" checked={this.state[ml_id]} id={ml_id} onChange={(e)=>this.select_ticker(e,'ML',ml_id,index,sector_name)} checked/></span>:
// 												<span><Switch size="small" id={ml_id} checked={this.state[ml_id]} onChange={(e)=>this.select_ticker(e,'ML',ml_id,index,sector_name)} /></span>}</td>
// 												</tr>
// 											);
// 											})
// 											}
...
// const WrappedSignUpForm = Form.create()(SignUp1);
