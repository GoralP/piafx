import {SWITCH_LANGUAGE, TOGGLE_COLLAPSED_NAV, WINDOW_WIDTH, GETVIDEOS_COMPLETE1} from "constants/ActionTypes";
...
export function getVideosCompleteSettings(data) {
  return {
    type: GETVIDEOS_COMPLETE1, payload:data};
}
