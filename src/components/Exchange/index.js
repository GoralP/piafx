...
class Exchange extends React.Component {
  ...
  selectexchange(value) {
    ...
    //   visible: false,
    // });
    // console.log('aspl',window.location.pathname)
      ...
      <div>
        <Widget title=" " styleName="gx-card-tabs sector_tabs exchange_widget">
          <Tabs defaultActiveKey="1">
            {Object.keys(this.props.exchangeList["Exchange"]).map(
              (key, index) => {
                // console.log('asplexchange',this.props.exchangeList);
                return (
                  <TabPane
                    tab={key}
                    key={index + 1}
                  ...
                  >
                    <div className="main_data">
                      {/* <h3>{key}</h3> */}
                      {Object.keys(
                        this.props.exchangeList["Exchange"][key]
                      ).map((item) => {
                        return (
                          <span
                            ...
                            onClick={() =>
                              this.selectexchange(
                                this.props.exchangeList["Exchange"][key][item]
                                  .code
                              )
                            }
                          >
