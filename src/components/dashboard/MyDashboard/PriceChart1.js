...
class PriceChart extends Component {
  constructor(props) {
    ...
    render() {
        ...
        var newvar = <div></div>
        var Button = <div></div>
          if(prestate.priceData.length > 0){
            var priceData = prestate.priceData[0];          
            ...
            {
            firstPlot.annotations().fromJson(this.props.getannotation_respo[0].price_json);
            }
            else
            {
            ...
            <div className="chart_head_cust">
              ...
              <select id="technicalindicator" onChange={() =>this.technicalindicator(firstPlot,mapping,chart,volumemapping)}>
            ...
            <div id="rangeselectorContainer" className="rangeselectorContainer" ></div>
...
const mapStateToProps =  state => {
  ...
  export default connect(mapStateToProps, {getmoveDate,changeScroller,addClicked,tableData})(PriceChart);
