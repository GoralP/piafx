          ...
          if (this.props.priceforecast.type == 3) {
            if (this.props.SnR2.length > 0) {
              ...
              this.props.SnR2[0]["high"].forEach((element, key) => {
                ...
                line2.normal().stroke("yellow", 1, "10 2");
                line2.normal().stroke("yellow", 2, "10 2");
                line2.selected().stroke("yellow", 3, "10 2");
                firstPlot
                  .textMarker(textkey)
                  .value(element["value"])
                  .text(
              ...
              if (this.props.trend1[0].length > 0) {
                this.props.trend1[0].forEach((element, key) => {
                  ...
                  if (element["lable"] == "Support") {
                    ...
                    trendline.normal().stroke("yellow", 1, "10 2");
                    color = "yellow";
              ...
              if (this.props.trend1[0].length > 0) {
                this.props.trend1[0].forEach((element, key) => {
                  ...
                  if (element["lable"] == "Support") {
                    ...
                    trendline.normal().stroke("yellow", 1, "10 2");
                    trendline.hovered().stroke("yellow", 2, "10 2");
                    trendline.selected().stroke("yellow", 3, "10 2");
                    color = "yellow";
                  } else if (element["lable"] == "Avg. Resistance") {
                    trendline.normal().stroke("green", 3, "10 2");
        ...
        const viewtasks = (
          ...
          >
            <SubMenu className="gx-menu-horizontal" title={<span>Volume</span>}>
              <Menu.Item onClick={() => this.changeVolume(0)}>Normal</Menu.Item>
              ...
              >
                ...
                >
                  <span className="gx-pointer gx-flex-row gx-align-items-center">
                    ...
                    <img
                      alt=""
                      src={require("assets/images/dark_icon/burger.png")}
                ...
                >
                  <span className="gx-pointer gx-flex-row gx-align-items-center">
                    ...
                    <img
                      alt=""
                      src={require("assets/images/dark_icon/eye.png")}
                      className="menu_icons"
                    />
                  </span>
                </Popover>
                ...
                >
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/Add.png")}
                    className="menu_icons"
                    style={{ marginTop: "5px" }}
                ...
                >
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/color.png")}
                ...
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/HLine.png")}
                    style={{ marginTop: "5px" }}
                ...
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/VLine.png")}
                    className="menu_icons"
                ...
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/SegmentLine.png")}
                    className="menu_icons"
                ...
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/ellipse.png")}
                    className="menu_icons"
                    onClick={() => this.createDrawing(chart, "ellipse")}
                    title="Ellipse"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/rectangle.png")}
                    className="menu_icons"
                    onClick={() => this.createDrawing(chart, "rectangle")}
                    title="Rectangle"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/arrow_up.png")}
                    className="menu_icons"
                    onClick={() =>
                      this.createDrawing(chart, "marker", "arrowUp")
                    }
                    title="Marker Up"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/arrow_down.png")}
                    className="menu_icons"
                    onClick={() =>
                      this.createDrawing(chart, "marker", "arrowDown")
                    }
                    title="Marker Down"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/diamond_ii.png")}
                    className="menu_icons"
                    onClick={() =>
                      this.createDrawing(chart, "marker", "diamond")
                    }
                    title="Diamond"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/circle.png")}
                    className="menu_icons"
                    onClick={() =>
                      this.createDrawing(chart, "marker", "circle")
                    }
                    title="Circle"
                  />
                </span>
                <span className="gx-pointer gx-flex-row gx-align-items-center">
                  ...
                  <img
                    alt=""
                    src={require("assets/images/dark_icon/square.png")}
                    className="menu_icons"
                    onClick={() =>
                      this.createDrawing(chart, "marker", "square")
                    }
                    title="Square"
                  />
                </span>
