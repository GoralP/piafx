...
class OiperTicker extends Component {
  static contextTypes = {
  ...
  render() {
    ...
    if (this.props.oiperticker != "") {
      ...
      var linechart;
      var j = 1;
      year20 = this.props.oiperticker.year20;
      year10 = this.props.oiperticker.year10;
      year5 = this.props.oiperticker.year5;
      year3 = this.props.oiperticker.year3;
      year1 = this.props.oiperticker.year1;
      month6 = this.props.oiperticker.month6;
      ...
      newvar = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(year20).map((key) => {
            ...
            var close_diff = year20[key]["max"] - year20[key]["currentOI"];
            ...
            // if(mean>=median)
            // {
            //   bulletchart.range(0).from(0).to(median);
            //   bulletchart.range(1).from(median).to(mean);
      ...
      newvar1 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(year10).map((key) => {
            ...
            var close_diff = year10[key]["max"] - year10[key]["currentOI"];
      ...
      newvar2 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(year5).map((key) => {
            ...
            var close_diff = year5[key]["max"] - year5[key]["currentOI"];
      ...
      newvar3 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(year3).map((key) => {
            ...
            var close_diff = year3[key]["max"] - year3[key]["currentOI"];
            ...
            // console.log('asplprice',year3[key]['pricedata'])
      ...
      newvar4 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(year1).map((key) => {
            ...
            var close_diff = year1[key]["max"] - year1[key]["currentOI"];
            ...
            // console.log('asplprice',year1[key]['pricedata'])
      ...
      newvar5 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(month6).map((key) => {
            var overall_diff = month6[key]["max"] - month6[key]["min"];
            var close_diff = month6[key]["max"] - month6[key]["currentOI"];
            var median_diff = month6[key]["max"] - month6[key]["median"];
            var mean_diff = month6[key]["max"] - month6[key]["mean"];
            var value = 100 - (close_diff * 100) / overall_diff;
            var median = 100 - (median_diff * 100) / overall_diff;
            var mean = 100 - (mean_diff * 100) / overall_diff;
            //   month6[key]['median'];
            ...
            // console.log('asplprice',month6[key]['pricedata'])
