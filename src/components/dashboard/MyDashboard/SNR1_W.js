...
class SNR1_W extends Component {
  static contextTypes = {
  ...
  render() {
    ...
    if (
      ...
      this.props.snrExt[0].data &&
      this.props.snrExt[0].data["5Y"] &&
      this.props.snrExt[0].data["10Y"] &&
      this.props.snrExt[0].data["1Y"] &&
      this.props.snrExt[0].data["2Y"]
    ) {
              ...
              return (
                <div>
                  <Row className="custom_main_chart">
                    ...
                    <Col lg={5} align="center">
                      <span class="net_badge">
                        {item["5Yavg"] === "resistance" ? (
                          <Badge color="#64b5f6" class="badge_cust snr" />
                        ) : item["5Yavg"] === "support" ? (
                          <Badge color="#cf4140" class="badge_cust snr" />
                        ) : null}
                      </span>
                    </Col>
                  </Row>
    ...
    return (
      ...
      >
        {/* <span className="cust_desciption cust-hass-font">S&R Machine Learning Weekly Breakout</span> */}
...
const mapStateToProps = (state) => {
  return {
    snrExt: Object.keys(state.Exchange.snrbreakoutdata)
      .filter((priceDataIndex) => priceDataIndex == "snr1_W")
      .map((priceDataIndex) => {
