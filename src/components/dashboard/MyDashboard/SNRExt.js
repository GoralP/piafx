...
class SNRExt extends Component {
    static contextTypes = {
    ...
    render() {
                ...
                return(
                    <div key={"div_"+ key}>
                        <Row className="custom_main_chart">
                            ...
                            <Col lg={5} align="center">
                                <span className="net_badge">{item['3Mavg']==='resistance'?<Badge color="#64b5f6" className="badge_cust snr"/>:item['3Mavg']==='support'?<Badge color="#cf4140" className="badge_cust snr"/>:null}</span>
                            </Col>
                        </Row>
                    </div>
                )
                ...
                return(
                    <div key={"divtwo_"+ key}>
                        <Row className="custom_main_chart">
                            ...
                            <Col lg={5} align="center">
                                <span className="net_badge">{item['6Mavg']==='resistance'?<Badge color="#64b5f6" className="badge_cust snr"/>:item['6Mavg']==='support'?<Badge color="#cf4140" className="badge_cust snr"/>:null}</span>
                            </Col>
                        </Row>
                    </div>
                )
            ...
            return(
                <div key={"divthree_"+ key}>
                    <Row className="custom_main_chart">
                        ...
                        <Col lg={5} align="center">
                            <span className="net_badge">{item['1Yavg']==='resistance'?<Badge color="#64b5f6" className="badge_cust snr"/>:item['1Yavg']==='support'?<Badge color="#cf4140" className="badge_cust snr"/>:null}</span>
                        </Col>
                    </Row>
                </div>
            )
            ...
            return(
                <div key={"divfour_"+ key}>
                    <Row className="custom_main_chart">
                        ...
                        <Col lg={5} align="center">
                            <span className="net_badge">{item['2Yavg']==='resistance'?<Badge color="#64b5f6" className="badge_cust snr"/>:item['2Yavg']==='support'?<Badge color="#cf4140" className="badge_cust snr"/>:null}</span>
                        </Col>
                    </Row>
                </div>
            )
        ...
        return (
            <div style={{"width":"100%"}} className="cust_bullet_chart cust_ecin_div cust-tab-font ">
              {/* <span className="cust_desciption cust-hass-font">S&R AI Ext. Breakout</span> */}
...
const mapStateToProps =  state => {
    ...
    return {
        snrExt: Object.keys(state.Exchange.snrbreakoutdata).filter(priceDataIndex => priceDataIndex == 'snrExt').map((priceDataIndex)=>{
            return state.Exchange.snrbreakoutdata[priceDataIndex];
        }),
    }
  };
  export default connect(mapStateToProps, {getmoveDate,changeScroller,addClicked,tableData})(SNRExt);
