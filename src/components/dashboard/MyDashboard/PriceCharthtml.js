  ...
  render() {
    ...
    if (this.props.priceData.length > 0) {
      if (this.props.priceData[0].length > 0) {
        ...
        chart.listenOnce("chartDraw", function() {
          // if(document.getElementById('rangeselectorContainer')!=null||document.getElementById('rangepickerContainer')!=null){
          // var isEmpty = document.getElementById('rangeselectorContainer').innerHTML === "";
          // if(isEmpty)
          // {
        ...
        if (
          ...
          aimenu.push(
            <SubMenu title={<span> {TSRMName} </span>}>
              ...
              <Menu.Item onClick={() => this.removeCorrell()}>Remove</Menu.Item>
            </SubMenu>
          );
        }
