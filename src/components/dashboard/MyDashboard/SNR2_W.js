...
class SNR2_W extends Component {
    static contextTypes = {
    ...
    render() {
        ...
        var title_date = '';
        if(this.props.snrExt.length > 0 && this.props.snrExt[0].data && this.props.snrExt[0].data['5Y'] && this.props.snrExt[0].data['10Y'] && this.props.snrExt[0].data['1Y'] && this.props.snrExt[0].data['2Y']){
            ...
            return(
                <div>
                    <Row className="custom_main_chart">
                        ...
                        <Col lg={5} align="center">
                            <span class="net_badge">{item['1Yavg']==='resistance'?<Badge color="#64b5f6" class="badge_cust snr"/>:item['1Yavg']==='support'?<Badge color="#cf4140" class="badge_cust snr"/>:null}</span>
                        </Col>
                    </Row>
                </div>
            )
            ...
            return(
                <div>
                    <Row className="custom_main_chart">
                        ...
                        <Col lg={5} align="center">
                            <span class="net_badge">{item['2Yavg']==='resistance'?<Badge color="#64b5f6" class="badge_cust snr"/>:item['2Yavg']==='support'?<Badge color="#cf4140" class="badge_cust snr"/>:null}</span>
                        </Col>
                    </Row>
                </div>
            )
        ...
        return (
            <div style={{"width":"100%"}} className="cust_bullet_chart cust_ecin_div cust-tab-font ">
              {/* <span className="cust_desciption cust-hass-font">S&R Vector Quantization Weekly Breakout</span> */}
                <div className="cust_price_chart" >
                    <Widget title="" styleName="sector_tabs gx-card-tabs" >  
                        <Tabs defaultActiveKey="1">
                            <TabPane tab="1Y" key="1" className="">
                                {newvar1Y}
                            </TabPane>
                            <TabPane tab="2Y" key="2" className="">
                                {newvar2Y}
                            </TabPane>
                            <TabPane tab="5Y" key="3" className="">
                                {newvar5Y}
                            </TabPane>
                            <TabPane tab="10Y" key="4" className="">
                                {newvar10Y}
                            </TabPane>
                        </Tabs>
                    </Widget>
...
const mapStateToProps =  state => {
    ...
    return {
        snrExt: Object.keys(state.Exchange.snrbreakoutdata).filter(priceDataIndex => priceDataIndex == 'snr2_W').map((priceDataIndex)=>{
            return state.Exchange.snrbreakoutdata[priceDataIndex];
        }),
    }
  };
  export default connect(mapStateToProps, {getmoveDate,changeScroller,addClicked,tableData})(SNR2_W);
