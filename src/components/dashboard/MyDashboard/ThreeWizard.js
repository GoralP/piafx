...
class ThreeWizard extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.SM && !isEqual(nextProps.SM,this.props.SM)) {
            return true;
        } else {
            return false;
        }
    ...
    render() {
        ...
        //   </div>
            ...
            //   {
              ...
              bulletscale5 = this.createBulletScale(parseInt(minimum),parseInt(maximum),parseInt((maximum/2)),1)
              // console.log('asplbullet',bulletscale);
              return(
                <div key={"div_"+positive5[key]['name']}>
                    <Row className="custom_main_chart">
                        <Col lg={2}>
                            <span className="cust-ticker-hover" onClick={()=>this.OpenModal(positive5[key]['key'])}>{positive5[key]['key']}</span>    
                        </Col>
                        <Col lg={6}>
            ...
            {Object.keys(negative5).map((key)=>{
              ...
              return(
                <div key={"divone_"+negative5[key]['name']}>
                    <Row className="custom_main_chart">
                        <Col lg={2}>
                            <span className="cust-ticker-hover" onClick={()=>this.OpenModal(negative5[key]['key'])}>{negative5[key]['key']}</span>    
                        </Col>
                        <Col lg={6}>
            ...
            newvar10 = <div className="cust_bullet_chart">
            <Row className="custom_main_chart_title cust-hass-font">
                <Col lg={2} align="center">
                    <span><strong>Code</strong></span>
                </Col>
            ...
            // Set bulletchart size and position settings
            bulletchart.bounds(0, 0, "100%", 125);
            bulletscale10 = this.createBulletScale(parseInt(minimum),parseInt(maximum),parseInt((maximum/2)),2)
            // console.log('asplbullet',bulletscale);
            return(
            <div key={"divtwo_"+positive10[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(positive10[key]['key'])}>{positive10[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
            ...
            <div key={"divthree_"+negative10[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(negative10[key]['key'])}>{negative10[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
            ...
            newvar15 = <div className="cust_bullet_chart">
            <Row className="custom_main_chart_title cust-hass-font">
                <Col lg={2} align="center">
                    <span><strong>Code</strong></span>
                </Col>
            ...
            // Set bulletchart size and position settings
            bulletchart.bounds(0, 0, "100%", 125);
            bulletscale15 = this.createBulletScale(parseInt(minimum),parseInt(maximum),parseInt((maximum/2)),3)
            // console.log('asplbullet',bulletscale);
            return(
            <div key={"divfour_"+positive15[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(positive15[key]['key'])}>{positive15[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
            ...
            <div key={"divfive_"+negative15[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(negative15[key]['key'])}>{negative15[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
            ...
            newvar20 = <div className="cust_bullet_chart">
            <Row className="custom_main_chart_title cust-hass-font">
                <Col lg={2} align="center">
                    <span><strong>Code</strong></span>
                </Col>
            ...
            // Set bulletchart size and position settings
            bulletchart.bounds(0, 0, "100%", 125);
            bulletscale20 = this.createBulletScale(parseInt(minimum),parseInt(maximum),parseInt((maximum/2)),4)
            // console.log('asplbullet',bulletscale);
            return(
            <div key={"divsix_"+positive20[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(positive20[key]['key'])}>{positive20[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
            ...
            // console.log('asplbullet',bulletscale);
            return(
            <div key={"divtseven_"+negative20[key]['name']}>
                <Row className="custom_main_chart">
                    <Col lg={2}>
                        <span className="cust-ticker-hover" onClick={()=>this.OpenModal(negative20[key]['key'])}>{negative20[key]['key']}</span>    
                    </Col>
                    <Col lg={6}>
        ...
        return (
            <div style={{"width":"100%"}} className="cust_bullet_chart cust_ecin_div cust-tab-font ">
              <span className="cust_desciption cust-hass-font">Three Wizard signal for day {title_date}</span>
...
const mapStateToProps =  state => {
    ...
    return {
        ...
        SM: Object.keys(state.Exchange.seasonalitydata).filter(priceDataIndex => priceDataIndex == 'TW').map((priceDataIndex)=>{
            return state.Exchange.seasonalitydata[priceDataIndex];
        }),
    }
  };
  export default connect(mapStateToProps, {getmoveDate,changeScroller,addClicked,tableData,confirmationModal1,testing})(ThreeWizard);
