...
import { getFalseBreakEvents, getFilterState } from "appRedux/actions/Exchange";
...
class FalseBreakEvents extends Component {
  constructor(props) {
    super(props);
  }
  state = {
  ...
  handleFalseBOEventSubmit = () => {
    if (
      this.props.fbAvailable &&
      this.props.fbAvailable.length > 0 &&
      this.props.fbAvailable[0].length > 0
    ) {
      this.setState({ filterStats: false });
      let dir = this.props.fbAvailable[0][0]["dir"];
      this.props.getFalseBreakEvents({
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      nextProps.eventsFBData !== this.props.eventsFBData ||
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.eventsFBData.maxX &&
      nextProps.eventsFBData.minX &&
      nextProps.eventsFBData.PriceLevel &&
      (nextProps.eventsFBData.maxX !== this.state.maxX ||
        nextProps.eventsFBData.minX !== this.state.minX ||
        nextProps.eventsFBData.PriceLevel !== this.state.calcPrice)
    ) {
      this.setState({
        maxX: nextProps.eventsFBData.maxX,
        minX: nextProps.eventsFBData.minX,
        maxVal: nextProps.eventsFBData.max,
        minVal: nextProps.eventsFBData.min,
        maxInputVal: nextProps.eventsFBData.maxX,
        minInputVal: nextProps.eventsFBData.minX,
        calcPrice: nextProps.eventsFBData.PriceLevel,
        calcPriceInputVal: nextProps.eventsFBData.PriceLevel,
      });
    }
    if (
      nextProps.priceData &&
  ...
  handleExportCode = () => {
    ...
    if (
      this.props.eventsFBData !== undefined &&
      this.props.eventsFBData.computeSeries &&
      Object.keys(this.props.eventsFBData.computeSeries).length > 0
    ) {
      pineCode =
        ...
        this.props.eventsFBData.computeSeries.computeR3 +
        "\r\nR2 = " +
        this.props.eventsFBData.computeSeries.computeR2 +
        "\r\nR1 = " +
        this.props.eventsFBData.computeSeries.computeR1 +
        "\r\nPL = " +
        this.props.eventsFBData.PriceLevel +
        "\r\nS1 = " +
        this.props.eventsFBData.computeSeries.computeS1 +
        "\r\nS2 = " +
        this.props.eventsFBData.computeSeries.computeS2 +
        "\r\nS3 = " +
        this.props.eventsFBData.computeSeries.computeS3 +
        '\r\n\r\nplot( R3,  "' +
        this.props.eventsFBData.percentageRatio +
        '% R3", ' +
        this.props.eventsFBData.computeSeries.colorR3 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( R2,  "' +
        this.props.eventsFBData.percentageRatio +
        '% R2", ' +
        this.props.eventsFBData.computeSeries.colorR2 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( R1,  "' +
        this.props.eventsFBData.percentageRatio +
        '% R1", ' +
        this.props.eventsFBData.computeSeries.colorR1 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( PL,  "' +
        this.props.eventsFBData.percentageRatio +
        '% PL", #9fa5a5, 1,trackprice = true, show_last = 1)\r\nplot( S1,  "' +
        this.props.eventsFBData.percentageRatio +
        '% S1", ' +
        this.props.eventsFBData.computeSeries.colorS1 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( S2,  "' +
        this.props.eventsFBData.percentageRatio +
        '% S2", ' +
        this.props.eventsFBData.computeSeries.colorS2 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( S3,  "' +
        this.props.eventsFBData.percentageRatio +
        '% S3", ' +
        this.props.eventsFBData.computeSeries.colorS3 +
        ", 3, trackprice = true, show_last = 1)\r\n";
  ...
  render() {
    ...
    if (
      ...
      if (
        ...
        const date1 = new Date(this.props.fbAvailable[0][0]["date"]);
    ...
    if (
      this.props.eventsFBData !== undefined &&
      this.props.eventsFBData.bubble &&
      this.props.eventsFBData.bubble.length > 0
    ) {
      ...
      // let markervalue = this.props.eventsFBData.bubble.find(x => x.date === this.props.fbAvailable[0][0]['date'])
      let markervalue = this.props.eventsFBData.bubble[
        this.props.eventsFBData.bubble.length - 1
      ];
      // let markervalue = this.props.eventsFBData.bubble.find(x => x.date === '2021-12-06')
      // console.log('asplpattern1',markervalue,this.props.fbAvailable[0][0]['date'],this.props.eventsFBData.bubble);
      switchClass = this.props.eventsFBData.switchClass;
      ...
      chart5.xAxis().title(this.props.eventsFBData.xName);
      chart5.yAxis().title(this.props.eventsFBData.yName);
      // if(daily['value5'])
      // {
      ...
      var purpleArray = [];
      var blueArray = [];
      this.props.eventsFBData.bubble.forEach((bubbleCO, key) => {
        if (this.state.colorAsCO) {
          if (this.props.eventsFBData.dir == "up") {
            if (bubbleCO.co < 0) {
          ...
          if (this.props.eventsFBData.dir == "up") {
            if (this.props.eventsFBData.BD > bubbleCO.co && bubbleCO.co < 0) {
              if (bubbleCO.co < 0) {
              ...
              if (bubbleCO.co < this.props.eventsFBData.BD) {
                purpleArray.push(bubbleCO);
                // return purple + " 0.75";
              } else if (bubbleCO.co >= this.props.eventsFBData.BD) {
                blueArray.push(bubbleCO);
                // return "#1C52BA 0.75";
              } else {
                blueArray.push(bubbleCO);
      ...
      // this.props.eventsFBData.bubble.sort(function (a, b) {
      //     return a.x - b.x
      // })
      chart5.xScale().minimum(this.props.eventsFBData.min);
      chart5.xScale().maximum(this.props.eventsFBData.max);
      // if (this.state.colorAsCO) {
      //   if (this.props.eventsFBData.dir == "up") {
      ...
      //       console.log(this.getData("co"));
      //       if (
      //         temp.props.eventsFBData.BD > this.getData("co") &&
      //         this.getData("co") < 0
      //       ) {
      //         if (this.getData("co") < 0) {
      //           return purple + " 0.75";
      ...
      //         }
      //       } else {
      //         if (this.getData("co") < temp.props.eventsFBData.BD) {
      //           return purple + " 0.75";
      //         } else if (this.getData("co") >= temp.props.eventsFBData.BD) {
      //           return "#1C52BA 0.75";
      //         } else {
      //           return blue + " 0.75";
      //         }
      ...
      //         }
      //       } else {
      //         if (this.getData("oo") < temp.props.eventsFBData.BD) {
      //           return purple;
      //         } else if (this.getData("co") >= temp.props.eventsFBData.BD) {
      //           return blue;
      //         } else {
      ...
      chart5.tooltip().format(function() {
        return (
          ...
          this.getData("date") +
          "<br> " +
          temp.props.eventsFBData.sizeName +
          " : " +
          this.getData("size") +
          "<br> " +
          temp.props.eventsFBData.xName +
          " : " +
          this.getData("x") +
          "<br> " +
          temp.props.eventsFBData.yName +
          " : " +
          this.getData("value")
        );
      });
    ...
    return (
      <div style={{ width: "100%" }}>
        {/* {(this.props.fbAvailable && this.props.fbAvailable.length>0 && this.props.fbAvailable[0].length>0)? */}
        {visible ? (
          <>
            <div align="center">
              <h2 style={{ color: charttext }}>
                False Break Daily Bars{" "}
                {this.props.fbAvailable[0][0]["dir"] === "down"
                  ? "Bearish"
                  : "Bullish"}{" "}
                Event Of {this.props.fbAvailable[0][0]["date"]}
              </h2>
            </div>
            <div className="cust_bullet_chart cust_ecin_div cust-tab-font">
              <Row className="EventMainRow event-row">
                  ...
                  <Row className="EventInputs " align="center">
                    ...
                    <Col lg={4}>
                      <Button
                        ...
                        onClick={() => this.handleFalseBOEventSubmit()}
                      >
                        Submit
                      </Button>
                    </Col>
                ...
                {this.props.eventsFBData !== undefined &&
                  this.props.eventsFBData.bubble &&
                  Object.keys(this.props.eventsFBData.bubble).length > 0 && (
                    <Row
              ...
              >
                <Col lg={24} className="">
                  {this.props.eventsFBData !== undefined &&
                    this.props.eventsFBData.calculatedArray &&
                    Object.keys(this.props.eventsFBData.calculatedArray)
                      .length > 0 && (
                      <>
                        <span className="stats_header" align="center">
                          <h2 style={{ color: charttext }}>
                            {/* set statistics title by vasudev */}
                            {this.props.eventsFBData.statLabel}{" "}
                        ...
                        <Row className="CalculatedText ">
                          ...
                          >
                            <div>
                              <strong>
                                {this.props.eventsFBData.calculatedArray.mean}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.std}
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.min}
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.max}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                          ...
                          >
                            <div>
                              <strong>
                                {this.props.eventsFBData.calculatedArray.per25}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.per50}
                            </div>
                            <div>
                              <strong>
                                {this.props.eventsFBData.calculatedArray.per75}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.per80}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                          ...
                          >
                            <div>
                              {this.props.eventsFBData.calculatedArray.per90}
                            </div>
                            <div>
                              <strong>
                                {this.props.eventsFBData.calculatedArray.per95}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsFBData.calculatedArray.per99}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                            ...
                            style={{ paddingLeft: "15px" }}
                          >
                            <div>{this.props.eventsFBData.upLabel}:</div>
                            <div>{this.props.eventsFBData.downLabel}:</div>
                          </Col>
                          <Col
                            lg={3}
                            align="left"
                          ...
                          >
                            <div>
                              {this.props.eventsFBData.calculatedArray.upCount}/
                              {
                                this.props.eventsFBData.calculatedArray
                                  .upCountPerc
                              }
                          ...
                          >
                            ...
                            <div>
                              {this.props.eventsFBData.calculatedArray.downCount}/
                              {
                                this.props.eventsFBData.calculatedArray
                                  .downCountPerc
                              }
              ...
              >
                <Col lg={24} className="">
                  {this.props.eventsFBData !== undefined &&
                    this.props.eventsFBData.computeSeries &&
                    Object.keys(this.props.eventsFBData.computeSeries).length >
                      0 && (
                      <>
                        <span className="stats_header" align="center">
                          <h2 style={{ color: charttext }}>
                            Levels for {this.props.eventsFBData.percentageRatio}
                            % of{" "}
                            {this.props.fbAvailable[0][0]["dir"] === "down"
                              ? "Bearish"
                              : "Bullish"}{" "}
...
const mapStateToProps = (state) => {
  return {
    ...
    eventsFBData: state.Exchange.eventsFBData,
    fbAvailable: Object.keys(state.Exchange.priceData)
      .filter((priceDataIndex) => priceDataIndex == "fbAvailable")
      .map((priceDataIndex) => {
...
export default connect(
  mapStateToProps,
  { getFalseBreakEvents, getFilterState }
)(FalseBreakEvents);
