...
class PriceChart extends PureComponent {
  ...
  render() {
    ...
    var resistanceColor = "#00A911";
    var resistanceAverageColor = "#00A911";
    var supportColor = "#D62828";
    var supportAverageColor = "#EA8080";
    ...
    if (theme == "coffee") {
      ...
      resistanceAverageColor = "green";
      supportColor = "red";
      supportAverageColor = "#605ac1";
      gridColor = "#9D9D9D";
      comColor = "#AC4317";
      noncomColor = "#009ECB";
      nonrepColor = "#2A353B";
              ...
              if (this.props.trend1[0].length > 0) {
                ...
                this.props.trend1[0].forEach((element, key) => {
                  ...
                  if (element["lable"] == "Support") {
                    ...
                    trendline.normal().stroke(supportAverageColor, 3, "10 2");
                    color = supportAverageColor;
                  } else if (element["lable"] == "Resistance") {
                    trendline.normal().stroke(resistanceColor, 2, "10 2");
                    color = resistanceColor;
                  } else if (element["lable"] == "Avg. Resistance") {
                    trendline
                      .normal()
                      .stroke(resistanceAverageColor, 3, "10 2");
            ...
            if (this.props.trend1.length > 0) {
              ...
              if (this.props.trend1[0].length > 0) {
                ...
                this.props.trend1[0].forEach((element, key) => {
                  ...
                  if (element["lable"] == "Support") {
                    trendline.normal().stroke(supportColor, 2, "10 2");
                    trendline.hovered().stroke(supportColor, 2, "10 2");
                    trendline.selected().stroke(supportColor, 3, "10 2");
                    color = supportColor;
                  } else if (element["lable"] == "Avg. Support") {
                    trendline.normal().stroke(supportAverageColor, 3, "10 2");
                    trendline.hovered().stroke(supportAverageColor, 4, "10 2");
                    trendline
                      .selected()
                      .stroke(supportAverageColor, 4.5, "10 2");
                    color = supportAverageColor;
                  } else if (element["lable"] == "Resistance") {
                    trendline.normal().stroke(resistanceColor, 2, "10 2");
                    trendline.hovered().stroke(resistanceColor, 2, "10 2");
                    trendline.selected().stroke(resistanceColor, 3, "10 2");
                    color = resistanceColor;
                  } else if (element["lable"] == "Avg. Resistance") {
                    trendline
                      .normal()
                    ...
                    trendline
                      .hovered()
                      .stroke(resistanceAverageColor, 4, "10 2");
                    trendline
                      .selected()
                      .stroke(resistanceAverageColor, 4.5, "10 2");
                    color = resistanceAverageColor;
                  }
                  if (element["x1"] == verticalline_date) {
                    firstPlot
