...
class PriceperTicker extends Component {
  static contextTypes = {
  ...
  render() {
    ...
    if (this.props.oiperticker != "") {
      ...
      var linechart;
      var j = 1;
      year20 = this.props.oiperticker.year20price;
      year10 = this.props.oiperticker.year10price;
      year5 = this.props.oiperticker.year5price;
      year3 = this.props.oiperticker.year3price;
      year1 = this.props.oiperticker.year1price;
      month6 = this.props.oiperticker.month6price;
      ...
      newvar5 = (
        <div className="cust_bullet_chart">
          ...
          {Object.keys(month6).map((key) => {
            ...
            var close_diff = month6[key]["max"] - month6[key]["currentPrice"];
