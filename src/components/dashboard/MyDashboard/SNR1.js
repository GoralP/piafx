...
class SNR1 extends Component {
  ...
  render() {
    ...
    if (
      ...
      this.props.snrExt[0].data["3M"] &&
      this.props.snrExt[0].data["6M"] &&
    ...
    return (
      ...
      >
        {/* <span className="cust_desciption cust-hass-font">S&R Machine Learning Breakout</span> */}
