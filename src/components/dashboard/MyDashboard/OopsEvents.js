...
import { getOopsEvents, getFilterState } from "appRedux/actions/Exchange";
...
class OopsEvents extends Component {
  constructor(props) {
    super(props);
  }
  state = {
  ...
  handleLineChange = () => {
    this.setState({
      ...
      calcPriceInputVal: this.state.calcPrice,
    });
  };
  ...
  handleBOEventSubmit = () => {
    if (
      this.props.oopsAvailable &&
      this.props.oopsAvailable.length > 0 &&
      this.props.oopsAvailable[0].length > 0
    ) {
      this.setState({ filterStats: false });
      let dir = this.props.oopsAvailable[0][0]["dir"];
      this.props.getOopsEvents({
  ...
  coPositive = (event) => {
    ...
    if (
      ...
      let dir = this.props.oopsAvailable[0][0]["dir"];
      // console.log({'ticker_code':localStorage.getItem('ticker_code'),'type':'bo','dir':dir,'x':this.state.boX,'y':this.state.boY,'size':this.state.boSize})
      this.props.getOopsEvents({
        ticker_code: localStorage.getItem("ticker_code"),
        type: "bo",
        dir: dir,
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      nextProps.eventsOopsData !== this.props.eventsOopsData ||
      ...
      nextState.calcPriceInputVal !== this.state.calcPriceInputVal ||
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.eventsOopsData.maxX &&
      nextProps.eventsOopsData.minX &&
      nextProps.eventsOopsData.PriceLevel &&
      (nextProps.eventsOopsData.maxX !== this.state.maxX ||
        nextProps.eventsOopsData.minX !== this.state.minX ||
        nextProps.eventsOopsData.PriceLevel !== this.state.calcPrice)
    ) {
      this.setState({
        maxX: nextProps.eventsOopsData.maxX,
        minX: nextProps.eventsOopsData.minX,
        maxVal: nextProps.eventsOopsData.max,
        minVal: nextProps.eventsOopsData.min,
        maxInputVal: nextProps.eventsOopsData.maxX,
        minInputVal: nextProps.eventsOopsData.minX,
        calcPrice: nextProps.eventsOopsData.PriceLevel,
        calcPriceInputVal: nextProps.eventsOopsData.PriceLevel,
      });
    }
    if (
      nextProps.priceData &&
  ...
  handleExportCode = () => {
    ...
    if (
      this.props.eventsOopsData !== undefined &&
      this.props.eventsOopsData.computeSeries &&
      Object.keys(this.props.eventsOopsData.computeSeries).length > 0
    ) {
      pineCode =
        ...
        this.props.eventsOopsData.computeSeries.computeR3 +
        "\r\nR2 = " +
        this.props.eventsOopsData.computeSeries.computeR2 +
        "\r\nR1 = " +
        this.props.eventsOopsData.computeSeries.computeR1 +
        "\r\nPL = " +
        this.props.eventsOopsData.PriceLevel +
        "\r\nS1 = " +
        this.props.eventsOopsData.computeSeries.computeS1 +
        "\r\nS2 = " +
        this.props.eventsOopsData.computeSeries.computeS2 +
        "\r\nS3 = " +
        this.props.eventsOopsData.computeSeries.computeS3 +
        '\r\n\r\nplot( R3,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% R3", ' +
        this.props.eventsOopsData.computeSeries.colorR3 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( R2,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% R2", ' +
        this.props.eventsOopsData.computeSeries.colorR2 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( R1,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% R1", ' +
        this.props.eventsOopsData.computeSeries.colorR1 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( PL,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% PL", #9fa5a5, 1,trackprice = true, show_last = 1)\r\nplot( S1,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% S1", ' +
        this.props.eventsOopsData.computeSeries.colorS1 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( S2,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% S2", ' +
        this.props.eventsOopsData.computeSeries.colorS2 +
        ', 3, trackprice = true, show_last = 1)\r\nplot( S3,  "' +
        this.props.eventsOopsData.percentageRatio +
        '% S3", ' +
        this.props.eventsOopsData.computeSeries.colorS3 +
        ", 3, trackprice = true, show_last = 1)\r\n";
  ...
  render() {
    ...
    if (
      ...
      if (
        ...
        const date1 = new Date(this.props.oopsAvailable[0][0]["date"]);
    ...
    if (
      this.props.eventsOopsData !== undefined &&
      this.props.eventsOopsData.bubble &&
      this.props.eventsOopsData.bubble.length > 0
    ) {
      ...
      // let markervalue = this.props.eventsOopsData.bubble.find(x => x.date === this.props.oopsAvailable[0][0]['date'])
      let markervalue = this.props.eventsOopsData.bubble[
        this.props.eventsOopsData.bubble.length - 1
      ];
      // let markervalue = this.props.eventsOopsData.bubble.find(x => x.date === '2021-12-06')
      // console.log('asplpattern1',markervalue,this.props.oopsAvailable[0][0]['date'],this.props.eventsOopsData.bubble);
      switchClass = this.props.eventsOopsData.switchClass;
      ...
      chart5.xAxis().title(this.props.eventsOopsData.xName);
      chart5.yAxis().title(this.props.eventsOopsData.yName);
      // if(daily['value5'])
      // {
      ...
      var purpleArray = [];
      var blueArray = [];
      this.props.eventsOopsData.bubble.forEach((bubbleCO, key) => {
        if (this.state.colorAsCO) {
          if (this.props.eventsOopsData.dir == "up") {
            if (bubbleCO.co < 0) {
          ...
          if (this.props.eventsOopsData.dir == "up") {
            if (this.props.eventsOopsData.BD > bubbleCO.co && bubbleCO.co < 0) {
              if (bubbleCO.co < 0) {
              ...
              if (bubbleCO.co < this.props.eventsOopsData.BD) {
                purpleArray.push(bubbleCO);
                // return purple + " 0.75";
              } else if (bubbleCO.co >= this.props.eventsOopsData.BD) {
                blueArray.push(bubbleCO);
                // return "#1C52BA 0.75";
              } else {
                blueArray.push(bubbleCO);
      ...
      // this.props.eventsOopsData.bubble.sort(function (a, b) {
      //     return a.x - b.x
      // })
      chart5.xScale().minimum(this.props.eventsOopsData.min);
      chart5.xScale().maximum(this.props.eventsOopsData.max);
      // if (this.state.colorAsCO) {
      //   if (this.props.eventsOopsData.dir == "up") {
      //     seriesRed5.fill(function() {
      ...
      //       console.log(this.getData("co"));
      //       if (
      //         temp.props.eventsOopsData.BD > this.getData("co") &&
      //         this.getData("co") < 0
      //       ) {
      //         if (this.getData("co") < 0) {
      //           return purple + " 0.75";
      ...
      //         }
      //       } else {
      //         if (this.getData("co") < temp.props.eventsOopsData.BD) {
      //           return purple + " 0.75";
      //         } else if (this.getData("co") >= temp.props.eventsOopsData.BD) {
      //           return "#1C52BA 0.75";
      //         } else {
      //           return blue + " 0.75";
      //         }
      ...
      //         }
      //       } else {
      //         if (this.getData("oo") < temp.props.eventsOopsData.BD) {
      //           return purple;
      //         } else if (this.getData("co") >= temp.props.eventsOopsData.BD) {
      //           return blue;
      //         } else {
      ...
      chart5.yScale().maximum(maxRound);
      ...
      chart5.tooltip().format(function() {
        return (
          ...
          this.getData("date") +
          "<br> " +
          temp.props.eventsOopsData.sizeName +
          " : " +
          this.getData("size") +
          "<br> " +
          temp.props.eventsOopsData.xName +
          " : " +
          this.getData("x") +
          "<br> " +
          temp.props.eventsOopsData.yName +
          " : " +
          this.getData("value")
        );
      });
      newvar = (
        <div className=" ">
          {/* <div align="center" ><h2 style={{color:charttext}}>Event scatter chart for S&R ML daily bars 3M Event Of {this.props.oopsAvailable[0][0]['date']}</h2></div>  */}
          {
            <AnyChart
              width="100%"
              height={400}
          ...
          {/* <Row className="EventMainRowInputsborder ">
            <Col lg={8}>
              <lable>Min </lable>
              <input
                type="number"
    ...
    return (
      <div style={{ width: "100%" }}>
        {/* {(this.props.oopsAvailable && this.props.oopsAvailable.length>0 && this.props.oopsAvailable[0].length>0)? */}
        {visible ? (
          <>
            <div align="center">
              <h2 style={{ color: charttext }}>
                Oops Daily Bars{" "}
                {this.props.oopsAvailable[0][0]["dir"] === "down"
                  ? "Bearish"
                  : "Bullish"}{" "}
                Event Of {this.props.oopsAvailable[0][0]["date"]}
              </h2>
            </div>
            <div className="cust_bullet_chart cust_ecin_div cust-tab-font">
              <Row className="EventMainRow event-row">
                <Col lg={24}>
                ...
                {this.props.eventsOopsData !== undefined &&
                  this.props.eventsOopsData.bubble &&
                  Object.keys(this.props.eventsOopsData.bubble).length > 0 && (
                    <Row
              ...
              >
                <Col lg={24} className="">
                  {this.props.eventsOopsData !== undefined &&
                    this.props.eventsOopsData.calculatedArray &&
                    Object.keys(this.props.eventsOopsData.calculatedArray)
                      .length > 0 && (
                      <>
                        <span className="stats_header" align="center">
                          <h2 style={{ color: charttext }}>
                            {/* set statistics title by vasudev */}
                            {this.props.eventsOopsData.statLabel}{" "}
                            {this.state.statLabelY}{" "}
                            {this.props.oopsAvailable[0][0]["dir"] === "down"
                              ? "Bearish"
                              : "Bullish"}{" "}
                            Candle For{" "}
                        ...
                        <Row className="CalculatedText ">
                          ...
                          >
                            <div>
                              <strong>
                                {this.props.eventsOopsData.calculatedArray.mean}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.std}
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.min}
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.max}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                          ...
                          >
                            ...
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per50}
                            </div>
                            <div>
                              <strong>
                                {
                            ...
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per80}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                          ...
                          >
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per90}
                            </div>
                            <div>
                              <strong>
                                {
                            ...
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per99}
                            </div>
                          </Col>
                          <Col
                            lg={3}
                            ...
                            style={{ paddingLeft: "15px" }}
                          >
                            <div>{this.props.eventsOopsData.upLabel}:</div>
                            <div>{this.props.eventsOopsData.downLabel}:</div>
                          </Col>
                          <Col
                            lg={3}
                            align="left"
                          ...
                          >
                            ...
                            {/* <div>
                              <strong>
                                {this.props.eventsOopsData.calculatedArray.per25}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per50}
                            ...
                            <div>
                              <strong>
                                {this.props.eventsOopsData.calculatedArray.per75}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per80}
                            ...
                            <div>
                              <strong>
                                {this.props.eventsOopsData.calculatedArray.per95}
                              </strong>
                            </div>
                            <div>
                              {this.props.eventsOopsData.calculatedArray.per99}
                            ...
                            <hr /> */}
                            {/* <div>
                              {this.props.eventsOopsData.calculatedArray.upCount}/
                              {
                                this.props.eventsOopsData.calculatedArray
                                  .upCountPerc
                              }
                            ...
                            <div>
                              {this.props.eventsOopsData.calculatedArray.downCount}/
                              {
                                this.props.eventsOopsData.calculatedArray
                                  .downCountPerc
                              }
                  ...
                  {this.props.eventsOopsData !== undefined &&
                    this.props.eventsOopsData.bubble &&
                    Object.keys(this.props.eventsOopsData.bubble).length >
                      0 && (
                      <Row>
              ...
              >
                <Col lg={24} className="">
                  {this.props.eventsOopsData !== undefined &&
                    this.props.eventsOopsData.computeSeries &&
                    Object.keys(this.props.eventsOopsData.computeSeries)
                      .length > 0 && (
                      <>
                        <span className="stats_header" align="center">
                          <h2 style={{ color: charttext }}>
                            Levels for{" "}
                            {this.props.eventsOopsData.percentageRatio}% of{" "}
                            {this.props.oopsAvailable[0][0]["dir"] === "down"
                              ? "Bearish"
                              : "Bullish"}{" "}
                            event
                        ...
                        <Row className="CalculatedText" align="center">
                          ...
                          >
                            ...
                            <div>
                              <strong>{this.state.calcPrice}</strong>
                            </div>
                            <div>
                              {
                                this.props.eventsOopsData.computeSeries
                  ...
                  <Row className="CalcRowInputs event-row">
                    ...
                    <Col lg={6} className="calcPrice">
                      ...
                      {/* <input
                        ...
                        onChange={this.handleChange1}
                        onBlur={this.handleLineChange}
                        // defaultValue={this.state.calcPrice}
                        // onChange={this.handleChange1}
                      ></input> */}
                      {theme == "default" ? (
                        <input
        ...
        >
          <Tabs defaultActiveKey="1" onChange={this.handleTabChange}>
            <TabPane tab="Pine Chart" key="1">
              <TextArea
                rows={20}
                defaultValue={this.state.pinceChartCode}
                onChange={(e) =>
            ...
            <TabPane tab="cAlgo" key="2">
              <TextArea
                rows={20}
                defaultValue={this.state.cAlgoCode}
...
const mapStateToProps = (state) => {
  return {
    filterState: state.Exchange.filterState,
    eventsOopsData: state.Exchange.eventsOopsData,
    oopsAvailable: Object.keys(state.Exchange.priceData)
      .filter((priceDataIndex) => priceDataIndex == "oopsAvailable")
      .map((priceDataIndex) => {
