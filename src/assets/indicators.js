...
import indicators from "./indicators.xml";
...
(function() {
  ...
  $.get(indicators, function(data) {
    $(data)
      .find("indicator")
      .each(function(index, item) {
        // console.log('asplrohan',item);
  ...
  function initHeightChart() {
    ...
    $("#chart-container").height(
      $(window).height() - $indicatorNavPanel.outerHeight() - creditsHeight
    );
  }

  function createChart(container, updateChart) {
    var dataName = $chartDataSelect
